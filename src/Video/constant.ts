...
import play_ctrl from '@/assets/icon/play_ctrl.png';
import pause_ctrl from '@/assets/icon/pause_ctrl.png';
...
export const Icon = {
  ...
  quitFullscreen: fullscreen,
  playCtrl: play_ctrl,
  pauseCtrl: pause_ctrl,
  thumb: thumb,
  volume:
...
export interface ModifyStateAction {
  ...
  payload: Partial<VideoPlayerState>;
}
