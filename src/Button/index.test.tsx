...
describe('test Button component', () => {
  ...
  it('should render default button', () => {
    ...
    expect(element).toHaveClass('cloudaccount-btn cloudaccount-btn-default');
  ...
  it('should render primary button', () => {
    ...
    expect(element).toHaveClass(
      'cloudaccount-btn cloudaccount-btn-sm cloudaccount-btn-primary test-btn',
    );
  });
  ...
  it('should render link btn', () => {
    ...
    expect(element).toHaveClass('cloudaccount-btn cloudaccount-btn-link');
  });
